...
const UserForm = ({ form }: { form: UseFormReturn<UserFormDto> }) => {
  const originOptions = [
    ...
    { label: 'Vibora', value: 'vibora' },
    { label: 'Bandaje', value: 'bandaje' },
    { label: 'Botella', value: 'botella' },
    { label: 'Servi', value: 'servi' },
    { label: 'Lente', value: 'lente' },
  ]

  return (
    <div className='md:grid md:grid-cols-2 flex flex-col gap-2 py-0 md:gap-4 md:py-4'>
      <DigitalInput name='name' placeholder='Escriba el nombre del usuario' label='Nombre' form={form} />
